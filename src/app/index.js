...
/* animation image4 */
document.querySelector("body > main > section:nth-of-type(1) > img:nth-child(4)").src = twcb;

/* animation image3 */
document.querySelector("body > main > section:nth-of-type(1) > img:nth-child(3)").src = owcpf;

/* animation image2 */
document.querySelector("body > main > section:nth-of-type(1) > img:nth-child(2)").src = owcbw;
